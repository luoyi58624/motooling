<template>
  ...
  <div class="login">
    ...
    <div class="group">
      <cube-input v-model="loginData.phoneCode" placeholder="请输入验证码" type="text" :maxlength="10" :autocomplete="false">
          <cube-button slot="append" :inline="true">获取验证码</cube-button>
      </cube-input>
    </div>
    <div class="group">
      <cube-button>登陆</cube-button>
